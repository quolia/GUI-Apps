...
Встроенный валидатор XML-сценариев показывает ошибки в сценариях. Синтаксические ошибки показываются пользователю вместе с контекстом (частью XML-файла с ошибкой), что позволяет легко находить и исправлять ошибки в сценариях.

![unnamed](https://user-images.githubusercontent.com/53271533/230766907-140462b0-5087-468d-8e24-02e7a0b23d05.png)

Встроенные таблицы структуры протокольных сообщений показываются пользователю в виде всплывающих подсказок.

![unnamed (1)](https://user-images.githubusercontent.com/53271533/230766908-9425d12f-824a-4c8c-aa3d-e4c7d4757454.png)

Встроенная система расшифровки аббревиатур в виде всплывающих подсказок.
...
Примеры HTTP-отчета о работе генератора трафика.
